...
class AntiPMMod(loader.Module):
    ...
    strings = {"name": "Anti PM",
               "limit_cfg_doc": "Максимальное количество сообщений перед блокировкой",
               "who_to_block": "<b>Укажите, кого заблокировать/b>",
               "blocked": ("<b>Я не хочу никаких сообщений от </b> <a href='tg://user?id={}'>you</a>, "
                           "<b>так что, Вы были заблокированы!</b>"),
               "who_to_unblock": "<b>Укажите, кого разблокировать</b>",
               "unblocked": ("<b>Okay! На этот раз я их разблокирую. PM разблокировал </b> "
