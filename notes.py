...
class NotesMod(loader.Module):
    ...
    strings = {"name": "Notes",
               "what_note": "<b>Какую заметку извлечь?</b>",
               "no_note": "<b>Заметка не найдена</b>",
               "save_what": "<b>Вы должны ответить на сообщение, чтобы сохранить его в заметку, или ввести заметку.</b>",
               "what_name": "<b>Необходимо указать название заметки</b>",
               ...
               "delnotes_none": "<b>Нет заметок для удаления</b>",
               "delnotes_done": "<b>Все заметки удалены</b>",
               "notes_none": "<b>Нет сохранённых заметок!</b>"}
