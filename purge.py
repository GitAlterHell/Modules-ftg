...
class PurgeMod(loader.Module):
    ...
    strings = {"name": "Purge",
               "from_where": "<b>Какие сообщения следует очистить?</b>",
               "not_supergroup_bot": "<b>Чистка может производиться только в супергруппах!</b>",
               "delete_what": "<b>Какие сообщения следует удалить?</b>"}
