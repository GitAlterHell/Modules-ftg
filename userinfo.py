...
class UserInfoMod(loader.Module):
    ...
    strings = {"name": "User Info",
               ...
               "verified": "\nVerified: <code>{}</code>",
               "dc_id": "\nDC ID: <code>{}</code>",
               "find_error": "<b>Не удалось найти данного пользователя.</b>",
               "no_args_or_reply": "<b>Не хватает аргументов.</b>",
               "provide_user": "Provide a user to locate",
               "searching_user": "Поиск пользователя...",
               "cannot_find": "Пользователь не найден.",
               "permalink_txt": "<a href='tg://user?id={uid}'>{txt}</a>",
               "permalink_uid": "<a href='tg://user?id={uid}'>Постоянная ссылка {uid}</a>",
    ...
    async def userinfocmd(self, message):
        """Использовать для получения информации о пользователе"""
        if message.is_reply:
